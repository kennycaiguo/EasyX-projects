...
int main()
{
	...
	zBuffer = new double[640 * 480];			// 开辟一个深度缓冲区，为每个像素留一个double值作为Z-buffer
	std::fill(zBuffer, zBuffer + 640 * 480, 1);	// 深度缓冲区全部设置为1
